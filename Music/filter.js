...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor("Applying: " + args[0], "https://cdn.discordapp.com/attachments/608531899429814283/882241348672040990/raze_bot_disk.gif","https://discord.com/api/oauth2/authorize?client_id=767885987740254291&permissions=49572160&scope=bot")).then(msg =>{
