...
execute(message, args) {
    ...
    queue.textChannel.send(
      new MessageEmbed()
        .setColor("#F0EAD6")
        .setAuthor(`${message.author.username}#${message.author.discriminator} skipped ${args[0]} songs`, "https://cdn.discordapp.com/attachments/608531899429814283/882241348672040990/raze_bot_disk.gif")
    ).catch(console.error);
  }
};
