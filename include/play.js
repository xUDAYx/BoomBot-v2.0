...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#FFF800")
        .setAuthor(`Music Queue ended.`, "https://cdn.discordapp.com/attachments/608531899429814283/882241348672040990/raze_bot_disk.gif")
  ...
  let thumb;
    if (song.thumbnail === undefined) thumb = "https://cdn.discordapp.com/attachments/608531899429814283/882241348672040990/raze_bot_disk.gif";
    else thumb = song.thumbnail.url;

  try {
      let embed = new MessageEmbed()
      .setColor("#FFF800")
      .setAuthor(`Started playing: ${song.title}`,'https://cdn.discordapp.com/attachments/608531899429814283/882241348672040990/raze_bot_disk.gif')
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        let nowPlaying = new MessageEmbed()
          .setAuthor('♪Now playing♪','https://cdn.discordapp.com/attachments/608531899429814283/882241348672040990/raze_bot_disk.gif','http://harmonymusic.tk')
      ...
      if (ms > 0 && ms<10000) {
        nowPlaying.addField("\u200b", "**``[" + createBar((ms == 0 ? seek : ms), seek, 25, "▬", "🔘")[0] + "]``**\n**" + "\n[" + new Date(seek * 1000).toISOString().substr(11, 8) + " / " + (ms == 0 ? " ◉ LIVE" : new Date(ms * 1000).toISOString().substr(11, 8))+ "]**" + "\n" + "\n **Time Remaining:**" + "``" + new Date(left * 1000).toISOString().substr(11, 8) + "``", false );
          ...
          .setAuthor("Searching...", "https://cdn.discordapp.com/attachments/608531899429814283/882241348672040990/raze_bot_disk.gif").setFooter("Lyrics")
          .setColor("#FFF800")
